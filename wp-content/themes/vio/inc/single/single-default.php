				...
				<div class="row">
                    ...
                    <?php } else { ?>
                    	<?php if ( 'leftsidebar' === vio_global_var( 'blog-layout', '', false ) ) { ?>
                    		<?php if ( 'three-grid' === vio_global_var( 'blog-layout-sidebar-width', '', false ) ) { ?>
                    			<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 pull-right">
                    		<?php } elseif ( 'four-grid' === vio_global_var( 'blog-layout-sidebar-width', '', false ) ) { ?>
                    			<div class="col-lg-8 col-md-7 col-sm-7 col-xs-12 pull-right">
                    		<?php } elseif ( 'five-grid' === vio_global_var( 'blog-layout-sidebar-width', '', false ) ) { ?>
                    ...
                    <?php } ?>
                    	...
                    	<div class="blog_single">
                    		...
                    		?>
                    		<?php if ( true == vio_global_var( 'display_tags', '', false ) ) : ?>
                    			<?php
                    			...
                    			<div class="nav-links">
                    				...
                    				if ( is_a( $prev_post, 'WP_Post' ) ) {
                    					...
                    					<div class="nav-previous">
                    						<a rel="prev" href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" title="<?php echo esc_attr( get_the_title( $prev_post->ID ) ); ?>"><strong><?php echo get_the_title( $prev_post->ID ); ?></strong> <?php echo esc_html__( 'Older Post', 'vio' ); ?></a>
                    					</div>
                    				<?php } ?>
                    				<?php
                    				...
                    				if ( is_a( $next_post, 'WP_Post' ) ) {
                    					?>
                    					<div class="nav-next">
                    						<a rel="next" href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" title="<?php echo esc_attr( get_the_title( $next_post->ID ) ); ?>"><strong><?php echo get_the_title( $next_post->ID ); ?></strong> <?php echo esc_html__( 'Newer Post', 'vio' ); ?></a>
                    					</div>
                    				<?php } ?>
                    			</div>
                    		</div>
                    		<!-- post-navigation -->
                    		<?php endif; ?>
                    		<?php if ( true == vio_global_var( 'display_author_information', '', false ) ) : ?>
                    			<?php if ( get_the_author_meta( 'description' ) ) : ?>
                    				...
                    				<div class="author-bio">
                    					<div class="holder">
                    						...
                    						<div class="data">
                    							<p class="designation">
                    								<?php echo esc_html__( 'Author', 'vio' ); ?>
                    							</p>
                    		...
                    		<?php endif; ?>
                    		<!-- comments-area -->
                    		<?php if ( vio_global_var( 'blog-layout', '', false ) ) : ?>
                    			<?php if ( vio_global_var( 'blog_comment_display', '', false ) ) : ?>
