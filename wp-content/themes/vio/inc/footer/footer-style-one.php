...
<footer class="wraper_footer style-default">
	...
	<?php
	if ( ! vio_global_var( 'hide-footer-widget', '', false ) ) {
			...
			<div class="row footer_copyright">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="footer_copyright_item text-left">
						<ul class="menu">
							<li><a href="<?php echo esc_url( vio_global_var( 'footer_one_copyright_link_one_url', '', false ) ); ?>"><?php echo esc_html( vio_global_var( 'footer_one_copyright_link_one_text', '', false ) ); ?></a></li>
							<li><a href="<?php echo esc_url( vio_global_var( 'footer_one_copyright_link_two_url', '', false ) ); ?>"><?php echo esc_html( vio_global_var( 'footer_one_copyright_link_two_text', '', false ) ); ?></a></li>
						</ul>
					</div>
					<!-- footer_copyright_item -->
				</div>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					...
					<div class="footer_copyright_item text-right">
						<p><?php echo wp_kses_post( vio_global_var( 'footer_one_copyright_text', '', false ) ); ?></p>
					</div>
					<!-- footer_copyright_item -->
				</div>
			</div>
