...
<header class="wraper_header style-sixteen">
	<!-- wraper_header_main -->
	<?php if ( true == vio_global_var( 'header_sixteen_sticky', '', false ) ) { ?>
	    <div data-delay="<?php echo esc_attr( vio_global_var( 'header_sixteen_sticky_delay', '', false ) ); ?>" class="wraper_header_main radiantthemes-sticky-style-<?php echo esc_attr( vio_global_var( 'header_sixteen_sticky_style', '', false ) ); ?>">
	<?php } else { ?>
	...
	<?php } ?>
		<div class="container">
			...
			<div class="row header_main">
				<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 text-left">
					...
					<div class="header_main_item">
						...
						<div class="brand-logo radiantthemes-retina">
						    <?php if ( vio_global_var( 'header_sixteen_logo', 'url', true ) ) { ?>
        						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( vio_global_var( 'header_sixteen_logo', 'url', true ) ); ?>" alt="<?php echo esc_attr( vio_global_var( 'header_sixteen_logo', 'alt', true ) ); ?>"></a>
        					<?php } else { ?>
				...
				<?php if ( true == vio_global_var( 'header_sixteen_actionarea_display', '', false ) ) { ?>
			    ...
			    <?php } ?>
					...
					<div class="header_main_item">
					    ...
					    <nav class="nav">
							<?php
							if ( true == vio_global_var( 'header_sixteen_menu_singlepagemode', '', false ) ) {
    							wp_nav_menu(
                                    array(
                                        'theme_location'    => 'top',
                                        'fallback_cb'       => false,
    				...
    				<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 text-right">
    					...
    					<div class="header_main_item">
    						...
    						<div class="header-main-action">
    							<ul>
    								<?php if ( ( class_exists( 'WooCommerce' ) ) && ( true == vio_global_var( 'header_sixteen_cart_display', '', false ) ) ) : ?>
    								...
    								<?php endif; ?>
    								<?php if ( true == vio_global_var( 'header_sixteen_search_display', '', false ) ) : ?>
    						...
    						<!-- header-main-action -->
    						<?php if ( true == vio_global_var( 'header_sixteen_hamburger_display', '', false ) ) : ?>
    							<?php if ( true == vio_global_var( 'header_sixteen_hamburger_mobile', '', false ) ) { ?>
...
<?php //if ( true == vio_global_var( 'header_sixteen_mobile_menu_display', '', false ) ) :
	?>
	<!-- mobile-menu -->
