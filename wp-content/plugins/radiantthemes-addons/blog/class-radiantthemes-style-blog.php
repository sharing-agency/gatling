					...
					'params'      => array(
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Style Two (No Image With Author Thumbnail)', 'radiantthemes-addons' )                  => 'two',
								esc_html__( 'Style Three (Classic)', 'radiantthemes-addons' )                                       => 'three',
								esc_html__( 'Style Four (Classic Without Excerpt) - Light', 'radiantthemes-addons' )                => 'four',
								esc_html__( 'Style Five (Classic With On Hover 3D Shadow)', 'radiantthemes-addons' )                => 'five',
								esc_html__( 'Style Six (Classic Without Button and Excerpt)', 'radiantthemes-addons' )              => 'six',
								esc_html__( 'Style Seven (Classic With Image Overlay Arrow)', 'radiantthemes-addons' )              => 'seven',
								esc_html__( 'Style Eight (Classic Without Excerpt With Creative Button)', 'radiantthemes-addons' )  => 'eight',
								esc_html__( 'Style Nine (With Image and Author Thumbnail)', 'radiantthemes-addons' )                => 'nine',
								esc_html__( 'Style Ten (ZigZag Articles)', 'radiantthemes-addons' )                                 => 'ten',
							),
							'std'        => 'one',
						),
						array(
						...
						array(
							...
							'param_name' => 'blog_select_title_font',
							'value'      => array(
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'blog_google_title_font',
							'dependency' => array(
								'element' => 'blog_select_title_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'blog_custom_title_font',
						...
						array(
							'type'       => 'font_container',
							'param_name' => 'blog_title_font_container',
							'value'      => '',
						...
						array(
							...
							'param_name'  => 'blog_title_font_style',
							'value'       => array(
						...
						array(
							...
							'param_name' => 'blog_select_content_font',
							'value'      => array(
								esc_html__( 'Select Font Type', 'radiantthemes-addons' ) => '',
								esc_html__( 'Google Font', 'radiantthemes-addons' )      => 'gfont',
								esc_html__( 'Custom Font', 'radiantthemes-addons' )      => 'cfont',
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'blog_google_content_font',
							'dependency' => array(
								'element' => 'blog_select_content_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'blog_custom_content_font',
							'value'      => $final_font_array,
							'dependency' => array(
								'element' => 'blog_select_content_font',
								'value'   => 'cfont',
						...
						array(
							'type'       => 'font_container',
							'param_name' => 'blog_content_font_container',
							'value'      => '',
							'group'      => esc_html__( 'Typography', 'radiantthemes-addons' ),
							'dependency' => array(
								'element' => 'blog_select_content_font',
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Font Weight', 'radiantthemes-addons' ),
							'param_name' => 'blog_content_font_weight',
							'value'      => '400',
							'group'      => 'Typography',
							'dependency' => array(
								'element' => 'blog_select_content_font',
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'radiantthemes-addons' ),
							'description' => esc_html__( 'Select font style.', 'radiantthemes-addons' ),
							'param_name'  => 'blog_content_font_style',
							'value'       => array(
								esc_html__( 'Regular', 'radiantthemes-addons' ) => 'normal',
								esc_html__( 'Italic', 'radiantthemes-addons' )  => 'italic',
							),
						...
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Date & Author Font', 'radiantthemes-addons' ),
							'param_name' => 'blog_select_tag_font',
							'value'      => array(
								esc_html__( 'Select Font Type', 'radiantthemes-addons' ) => '',
								esc_html__( 'Google Font', 'radiantthemes-addons' )      => 'gfont',
								esc_html__( 'Custom Font', 'radiantthemes-addons' )      => 'cfont',
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'blog_google_tag_font',
							'dependency' => array(
								'element' => 'blog_select_tag_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'blog_custom_tag_font',
							'value'      => $final_font_array,
							'dependency' => array(
								'element' => 'blog_select_tag_font',
								'value'   => 'cfont',
						...
						array(
							'type'       => 'font_container',
							'param_name' => 'blog_tag_font_container',
							'value'      => '',
							'group'      => esc_html__( 'Typography', 'radiantthemes-addons' ),
							'dependency' => array(
								'element' => 'blog_select_tag_font',
							...
							'settings'   => array(
								'fields' => array(
									...
									'font_size_description' => esc_html__( 'Enter font size.', 'radiantthemes-addons' ),
									'line_height_description' => esc_html__( 'Enter line height.', 'radiantthemes-addons' ),
									'color_description' => esc_html__( 'Select tag color.', 'radiantthemes-addons' ),
								),
							),
						),
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Font Weight', 'radiantthemes-addons' ),
							'param_name' => 'blog_tag_font_weight',
							'value'      => '400',
							'group'      => 'Typography',
							'dependency' => array(
								'element' => 'blog_select_tag_font',
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'radiantthemes-addons' ),
							'description' => esc_html__( 'Select font style.', 'radiantthemes-addons' ),
							'param_name'  => 'blog_tag_font_style',
							'value'       => array(
								esc_html__( 'Regular', 'radiantthemes-addons' ) => 'normal',
								esc_html__( 'Italic', 'radiantthemes-addons' )  => 'italic',
							),
		...
		public function radiantthemes_blog_style_func( $atts, $content = null, $tag ) {
			...
			$shortcode = shortcode_atts(
				array(
					...
					'extra_class'                 => '',
					'extra_id'                    => '',
					'blog_select_title_font'      => '',
					'blog_google_title_font'      => '',
					'blog_custom_title_font'      => 'Great Vibes',
					'blog_title_font_container'   => '',
					'blog_title_font_weight'      => '400',
					'blog_title_font_style'       => 'normal',
					'blog_select_content_font'    => '',
					'blog_google_content_font'    => '',
					'blog_custom_content_font'    => 'Great Vibes',
					'blog_content_font_container' => '',
					'blog_content_font_weight'    => '400',
					'blog_content_font_style'     => 'normal',
					'blog_select_tag_font'        => '',
					'blog_google_tag_font'        => '',
					'blog_custom_tag_font'        => 'Great Vibes',
					'blog_tag_font_container'     => '',
					'blog_tag_font_weight'        => '400',
					'blog_tag_font_style'         => 'normal',
				),
				$atts
			);

			if ( $shortcode['blog_title_font_container'] ) {
				$blog_title_font_container    = explode( '|', $shortcode['blog_title_font_container'] );
				$blog_title_font_container[1] = urldecode( $blog_title_font_container[1] );
				$blog_title_font_container    = implode( ';', $blog_title_font_container );
				$blog_title_font_container    = str_replace( '_', '-', $blog_title_font_container );
				$blog_title_font_container    = $blog_title_font_container . ';';
			} else {
				$blog_title_font_container = '';
			}

			if ( $shortcode['blog_content_font_container'] ) {
				$blog_content_font_container    = explode( '|', $shortcode['blog_content_font_container'] );
				$blog_content_font_container[1] = urldecode( $blog_content_font_container[1] );
				$blog_content_font_container    = implode( ';', $blog_content_font_container );
				$blog_content_font_container    = str_replace( '_', '-', $blog_content_font_container );
				$blog_content_font_container    = $blog_content_font_container . ';';
			} else {
				$blog_content_font_container = '';
			}

			if ( $shortcode['blog_tag_font_container'] ) {
				$blog_tag_font_container    = explode( '|', $shortcode['blog_tag_font_container'] );
				$blog_tag_font_container[1] = urldecode( $blog_tag_font_container[1] );
				$blog_tag_font_container    = implode( ';', $blog_tag_font_container );
				$blog_tag_font_container    = str_replace( '_', '-', $blog_tag_font_container );
				$blog_tag_font_container    = $blog_tag_font_container . ';';
			} else {
				$blog_tag_font_container = '';
			}

			if ( 'gfont' === $shortcode['blog_select_title_font'] ) {

				// Build the blockquote font array.
				$blog_google_title_font = $this->get_fonts_data( $shortcode['blog_google_title_font'] );

				// Build the inline style.
				$blog_title_font_inline_style = $this->google_fonts_styles( $blog_google_title_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $blog_google_title_font );

				$blog_title_weight_style      = '';

			} elseif ( 'cfont' === $shortcode['blog_select_title_font'] ) {

				// Build the inline style.
				$blog_title_font_inline_style = 'font-family: ' . $shortcode['blog_custom_title_font'] . ';';
				$blog_title_weight_style      = 'font-weight: ' . $shortcode['blog_title_font_weight'] . ';font-style: ' . $shortcode['blog_title_font_style'] . ';';

			} else {

				$blog_title_font_inline_style = '';
				$blog_title_weight_style      = '';

			}

			if ( 'gfont' === $shortcode['blog_select_content_font'] ) {

				// Build the blockquote font array.
				$blog_google_content_font = $this->get_fonts_data( $shortcode['blog_google_content_font'] );

				// Build the inline style.
				$blog_content_font_inline_style = $this->google_fonts_styles( $blog_google_content_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $blog_google_content_font );

				$blog_content_weight_style      = '';

			} elseif ( 'cfont' === $shortcode['blog_select_content_font'] ) {

				// Build the inline style.
				$blog_content_font_inline_style = 'font-family: ' . $shortcode['blog_custom_content_font'] . ';';
				$blog_content_weight_style      = 'font-weight: ' . $shortcode['blog_content_font_weight'] . ';font-style: ' . $shortcode['blog_content_font_style'] . ';';

			} else {

				$blog_content_font_inline_style = '';
				$blog_content_weight_style      = '';

			}

			if ( 'gfont' === $shortcode['blog_select_tag_font'] ) {

				// Build the blockquote font array.
				$blog_google_tag_font = $this->get_fonts_data( $shortcode['blog_google_tag_font'] );

				// Build the inline style.
				$blog_tag_font_inline_style = $this->google_fonts_styles( $blog_google_tag_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $blog_google_tag_font );

				$blog_tag_weight_style = '';

			} elseif ( 'cfont' === $shortcode['blog_select_tag_font'] ) {

				// Build the inline style.
				$blog_tag_font_inline_style = 'font-family: ' . $shortcode['blog_custom_tag_font'] . ';';
				$blog_tag_weight_style      = 'font-weight: ' . $shortcode['blog_tag_font_weight'] . ';font-style: ' . $shortcode['blog_tag_font_style'] . ';';

			} else {

				$blog_tag_font_inline_style = '';
				$blog_tag_weight_style      = '';
			...
			// ADD CUSTOM CSS.
			$custom_css  = $shortcode['blog_color'] ? '.blog.element-one.' . $random_class . ' .blog-item > .holder > .data .title,
			.blog.element-one.' . $random_class . ' .blog-item > .holder > .data .btn,
			.blog.element-three.' . $random_class . ' .blog-item > .holder > .data .btn{
			    color: ' . $shortcode['blog_color'] . ' ;
			}
			.blog.element-seven.' . $random_class . ' .blog-item > .holder > .pic > .pic-overlay,
			.blog.element-ten.' . $random_class . ' .blog-item > .holder > .more .btn{
			...
			if ( 'false' == $shortcode['blog_allow_carousel'] ) {
				if ( 'ten' == $shortcode['style_variation'] ) {
