				...
				array(
					...
					'params'      => array(
						array(
							...
							'value'      => array(
								esc_html__( 'Style One (Large Top Image)', 'radiantthemes-addons' )                               => 'one',
								esc_html__( 'Style Two (Classic Left No Image) - Light', 'radiantthemes-addons' )                 => 'two',
								esc_html__( 'Style Three (Classic Left Top Image)', 'radiantthemes-addons' )                      => 'three',
								esc_html__( 'Style Four (Classic Center No Image/Designation) - Light', 'radiantthemes-addons' )  => 'four',
								esc_html__( 'Style Five (Classic Left No Image/Designation) - Dark', 'radiantthemes-addons' )     => 'five',
								esc_html__( 'Style Six (Classic Left Bottom Image)', 'radiantthemes-addons' )                     => 'six',
								esc_html__( 'Style Seven (Classic Left Top Image Shadow)', 'radiantthemes-addons' )               => 'seven',
							),
							'std'        => 'one',
							'weight'     => 2,
						),
						array(
							...
							'description' => esc_html__( 'Set your Testimonial Color Scheme. (If not selected, it will take default color)', 'radiantthemes-addons' ),
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Center Dot (Dark)', 'radiantthemes-addons' )   => 'one',
								esc_html__( 'Right Dot (Light)', 'radiantthemes-addons' )    => 'two',
							),
							'dependency' => array(
								'element' => 'allow_dots',
								'value'   => 'true',
						...
						array(
							...
							'param_name' => 'testimonial_quote_select_font',
							'value'      => array(
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'testimonial_quote_google_font',
							'dependency' => array(
								'element' => 'testimonial_quote_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'testimonial_quote_custom_font',
						...
						array(
							'type'       => 'font_container',
							'param_name' => 'testimonial_quote_font_container',
							'value'      => '',
							'group'      => esc_html__( 'Typography', 'radiantthemes-addons' ),
							'dependency' => array(
								'element' => 'testimonial_quote_select_font',
							...
							'settings'   => array(
								'fields' => array(
									...
									'color_description' => esc_html__( 'Select Quote color.', 'radiantthemes-addons' ),
								),
							),
						),
						array(
							...
							'param_name' => 'testimonial_quote_font_weight',
							'value'      => '400',
							'group'      => 'Typography',
							'dependency' => array(
								'element' => 'testimonial_quote_select_font',
						...
						array(
							...
							'param_name'  => 'testimonial_quote_font_style',
							'value'       => array(
						...
						array(
							...
							'param_name' => 'testimonial_title_select_font',
							'value'      => array(
								esc_html__( 'Select Font Type', 'radiantthemes-addons' ) => '',
								esc_html__( 'Google Font', 'radiantthemes-addons' )      => 'gfont',
								esc_html__( 'Custom Font', 'radiantthemes-addons' )      => 'cfont',
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'testimonial_title_google_font',
							'dependency' => array(
								'element' => 'testimonial_title_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'testimonial_title_custom_font',
							'value'      => $final_font_array,
							'dependency' => array(
								'element' => 'testimonial_title_select_font',
								'value'   => 'cfont',
						...
						array(
							'type'       => 'font_container',
							'param_name' => 'testimonial_title_font_container',
							'value'      => '',
							'group'      => esc_html__( 'Typography', 'radiantthemes-addons' ),
							'dependency' => array(
								'element' => 'testimonial_title_select_font',
						...
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Designation Font', 'radiantthemes-addons' ),
							'param_name' => 'testimonial_designation_select_font',
							'value'      => array(
								esc_html__( 'Select Font Type', 'radiantthemes-addons' ) => '',
								esc_html__( 'Google Font', 'radiantthemes-addons' )      => 'gfont',
								esc_html__( 'Custom Font', 'radiantthemes-addons' )      => 'cfont',
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'testimonial_designation_google_font',
							'dependency' => array(
								'element' => 'testimonial_designation_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'testimonial_designation_custom_font',
							'value'      => $final_font_array,
							'dependency' => array(
								'element' => 'testimonial_designation_select_font',
								'value'   => 'cfont',
						...
						array(
							'type'       => 'font_container',
							'param_name' => 'testimonial_designation_font_container',
							'value'      => '',
							'group'      => esc_html__( 'Typography', 'radiantthemes-addons' ),
							'dependency' => array(
								'element' => 'testimonial_designation_select_font',
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Font Weight', 'radiantthemes-addons' ),
							'param_name' => 'testimonial_designation_font_weight',
							'value'      => '400',
							'group'      => 'Typography',
							'dependency' => array(
								'element' => 'testimonial_designation_select_font',
						...
						array(
							...
							'heading'     => esc_html__( 'Font Style', 'radiantthemes-addons' ),
							'description' => esc_html__( 'Select font style.', 'radiantthemes-addons' ),
							'param_name'  => 'testimonial_designation_font_style',
							'value'       => array(
								esc_html__( 'Regular', 'radiantthemes-addons' ) => 'normal',
								esc_html__( 'Italic', 'radiantthemes-addons' )  => 'italic',
							),
		...
		public function radiantthemes_testimonial_style_func( $atts, $content = null, $tag ) {
			$shortcode = shortcode_atts(
				array(
					...
					'extra_class'                            => '',
					'extra_id'                               => '',
					'testimonial_quote_select_font'          => '',
					'testimonial_quote_google_font'          => '',
					'testimonial_quote_custom_font'          => '',
					'testimonial_quote_font_container'       => '',
					'testimonial_quote_font_weight'          => '400',
					'testimonial_quote_font_style'           => 'normal',
					'testimonial_title_select_font'          => '',
					'testimonial_title_google_font'          => '',
					'testimonial_title_custom_font'          => '',
					'testimonial_title_font_container'       => '',
					'testimonial_title_font_weight'          => '400',
					'testimonial_title_font_style'           => 'normal',
					'testimonial_designation_select_font'    => '',
					'testimonial_designation_google_font'    => '',
					'testimonial_designation_custom_font'    => '',
					'testimonial_designation_font_container' => '',
					'testimonial_designation_font_weight'    => '400',
					'testimonial_designation_font_style'     => 'normal',
				),
				$atts
			);

			if ( $shortcode['testimonial_quote_font_container'] ) {
				$testimonial_quote_font_container    = explode( '|', $shortcode['testimonial_quote_font_container'] );
				$testimonial_quote_font_container[1] = urldecode( $testimonial_quote_font_container[1] );
				$testimonial_quote_font_container    = implode( ';', $testimonial_quote_font_container );
				$testimonial_quote_font_container    = str_replace( '_', '-', $testimonial_quote_font_container );
				$testimonial_quote_font_container    = $testimonial_quote_font_container . ';';
			} else {
				$testimonial_quote_font_container = '';
			}

			if ( $shortcode['testimonial_title_font_container'] ) {
				$testimonial_title_font_container    = explode( '|', $shortcode['testimonial_title_font_container'] );
				$testimonial_title_font_container[1] = urldecode( $testimonial_title_font_container[1] );
				$testimonial_title_font_container    = implode( ';', $testimonial_title_font_container );
				$testimonial_title_font_container    = str_replace( '_', '-', $testimonial_title_font_container );
				$testimonial_title_font_container    = $testimonial_title_font_container . ';';
			} else {
				$testimonial_title_font_container = '';
			}

			if ( $shortcode['testimonial_designation_font_container'] ) {
				$testimonial_designation_font_container    = explode( '|', $shortcode['testimonial_designation_font_container'] );
				$testimonial_designation_font_container[1] = urldecode( $testimonial_designation_font_container[1] );
				$testimonial_designation_font_container    = implode( ';', $testimonial_designation_font_container );
				$testimonial_designation_font_container    = str_replace( '_', '-', $testimonial_designation_font_container );
				$testimonial_designation_font_container    = $testimonial_designation_font_container . ';';
			} else {
				$testimonial_designation_font_container = '';
			}

			if ( 'gfont' === $shortcode['testimonial_quote_select_font'] ) {

				// Build the testimonial quote font array.
				$testimonial_quote_google_font = $this->get_fonts_data( $shortcode['testimonial_quote_google_font'] );

				// Build the inline style.
				$testimonial_quote_font_inline_style = $this->google_fonts_styles( $testimonial_quote_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $testimonial_quote_google_font );

				$testimonial_quote_weight_style = '';

			} elseif ( 'cfont' === $shortcode['testimonial_quote_select_font'] ) {

				// Build the inline style.
				$testimonial_quote_font_inline_style = 'font-family: ' . $shortcode['testimonial_quote_custom_font'] . ';';
				$testimonial_quote_weight_style      = 'font-weight: ' . $shortcode['testimonial_quote_font_weight'] . ';font-style: ' . $shortcode['testimonial_quote_font_style'] . ';';

			} else {

				$testimonial_quote_font_inline_style = '';
				$testimonial_quote_weight_style      = '';

			}

			if ( 'gfont' === $shortcode['testimonial_title_select_font'] ) {

				// Build the testimonial title font array.
				$testimonial_title_google_font = $this->get_fonts_data( $shortcode['testimonial_title_google_font'] );

				// Build the inline style.
				$testimonial_title_font_inline_style = $this->google_fonts_styles( $testimonial_title_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $testimonial_title_google_font );

				$testimonial_title_weight_style = '';

			} elseif ( 'cfont' === $shortcode['testimonial_title_select_font'] ) {

				// Build the inline style.
				$testimonial_title_font_inline_style = 'font-family: ' . $shortcode['testimonial_title_custom_font'] . ';';
				$testimonial_title_weight_style      = 'font-weight: ' . $shortcode['testimonial_title_font_weight'] . ';font-style: ' . $shortcode['testimonial_title_font_style'] . ';';

			} else {

				$testimonial_title_font_inline_style = '';
				$testimonial_title_weight_style      = '';

			}

			if ( 'gfont' === $shortcode['testimonial_designation_select_font'] ) {

				// Build the call to action font array.
				$testimonial_designation_google_font = $this->get_fonts_data( $shortcode['testimonial_designation_google_font'] );

				// Build the inline style.
				$testimonial_designation_font_inline_style = $this->google_fonts_styles( $testimonial_designation_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $testimonial_designation_google_font );

				$testimonial_designation_weight_style = '';

			} elseif ( 'cfont' === $shortcode['testimonial_designation_select_font'] ) {

				// Build the inline style.
				$testimonial_designation_font_inline_style = 'font-family: ' . $shortcode['testimonial_designation_custom_font'] . ';';
				$testimonial_designation_weight_style      = 'font-weight: ' . $shortcode['testimonial_designation_font_weight'] . ';font-style: ' . $shortcode['testimonial_designation_font_style'] . ';';

			} else {

				$testimonial_designation_font_inline_style = '';
				$testimonial_designation_weight_style      = '';
			...
			$custom_css .= $shortcode['testimonial_color'] ? '.testimonial.element-one.' . $random_class . ' .testimonial-item > .holder > .testimonial-pic > .testimonial-pic-holder > .testimonial-pic-icon,
            ...
            .testimonial[class*="element-"].owl-dot-style-one.' . $random_class . ' .owl-dots > .owl-dot.active > span,
            ...
            .testimonial.element-seven.' . $random_class . ' .testimonial-item > .holder > .testimonial-main > .testimonial-title .title{
            	color: ' . $shortcode['testimonial_color'] . ';
            }
            .testimonial.element-seven.' . $random_class . ' .testimonial-item > .holder:hover{
			...
			if ( 'all' === $shortcode['testimonial_category_list'] ) {
				...
				$testimonial_category = array(
					array(
						...
						'field'    => 'slug',
						'terms'    => esc_attr( $shortcode['testimonial_category_list'] ),
					),
				);
			}
					...
					if ( 'one' === $shortcode['testimonial_style'] ) {
						...
						$output             .= '<div class="holder">';
							...
							$output         .= '<div class="testimonial-data">';
								$output     .= '<blockquote>';
									$output .= '<p style="' . $testimonial_quote_font_inline_style . $testimonial_quote_font_container . $testimonial_quote_weight_style . '">"' . esc_attr( get_the_content() ) . '"</p>';
								$output     .= '</blockquote>';
							$output         .= '</div>';
							$output         .= '<div class="testimonial-title">';
								$output     .= '<h4 style="' . $testimonial_title_font_inline_style . $testimonial_title_font_container . $testimonial_title_weight_style . '" class="title">' . esc_attr( get_the_title() ) . '</h4>';
								$output     .= '<p style="' . $testimonial_designation_font_inline_style . $testimonial_designation_font_container . $testimonial_designation_weight_style . '" class="designation">' . esc_attr( get_post_meta( get_the_ID(), '_testimonial_designation', true ) ) . '</p>';
							$output         .= '</div>';
						$output             .= '</div>';
						...
						$output             .= '<div class="holder">';
							...
							$output         .= '<div class="testimonial-title">';
								$output     .= '<div class="testimonial-title-pic" style="background-image:url(' . get_the_post_thumbnail_url( get_the_ID() ) . ');"></div>';
								$output     .= '<div class="testimonial-title-data">';
									$output .= '<h4 style="' . $testimonial_title_font_inline_style . $testimonial_title_font_container . $testimonial_title_weight_style . '" class="title">' . esc_attr( get_the_title() ) . '<u style="' . $testimonial_designation_font_inline_style . $testimonial_designation_font_container . $testimonial_designation_weight_style . '">' . esc_attr( get_post_meta( get_the_ID(), '_testimonial_designation', true ) ) . '</u></h4>';
								$output     .= '</div>';
							$output         .= '</div>';
						$output             .= '</div>';
