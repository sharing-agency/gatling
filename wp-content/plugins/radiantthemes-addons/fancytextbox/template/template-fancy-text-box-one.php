...
if ( esc_url( $fancy_textbox_link_url ) !== '' ) {
	$output     .= '<div class="more">';
		$output .= '<a style="' . $fancy_link_font_inline_style . $fancy_link_font_container . $fancy_link_weight_style . '" class="btn" href="' . esc_url( $fancy_textbox_link_url ) . '" ' . $fancy_textbox_link_target . '' . $fancy_textbox_link_rel . '>' . $fancy_textbox_link_title . '<i class="fa fa-arrow-right"></i></a>';
	$output     .= '</div>';
}
		$output .= '</div>';
	$output     .= '</div>';
