				...
				array(
					...
					'params'      => array(
						...
						array(
							...
							'param_name' => 'cta_title_select_font',
							'value'      => array(
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'cta_title_google_font',
							'dependency' => array(
								'element' => 'cta_title_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'cta_title_custom_font',
						...
						array(
							...
							'param_name' => 'cta_content_select_font',
							'value'      => array(
								esc_html__( 'Select Font Type', 'radiantthemes-addons' ) => '',
								esc_html__( 'Google Font', 'radiantthemes-addons' )      => 'gfont',
								esc_html__( 'Custom Font', 'radiantthemes-addons' )      => 'cfont',
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'cta_content_google_font',
							'dependency' => array(
								'element' => 'cta_content_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'cta_content_custom_font',
							'value'      => $final_font_array,
							'dependency' => array(
								'element' => 'cta_content_select_font',
								'value'   => 'cfont',
						...
						array(
							...
							'param_name' => 'cta_subtitle_select_font',
							'value'      => array(
								esc_html__( 'Select Font Type', 'radiantthemes-addons' ) => '',
								esc_html__( 'Google Font', 'radiantthemes-addons' )      => 'gfont',
								esc_html__( 'Custom Font', 'radiantthemes-addons' )      => 'cfont',
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'cta_subtitle_google_font',
							'dependency' => array(
								'element' => 'cta_subtitle_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'cta_subtitle_custom_font',
							'value'      => $final_font_array,
							'dependency' => array(
								'element' => 'cta_subtitle_select_font',
								'value'   => 'cfont',
						...
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Button Title Font', 'radiantthemes-addons' ),
							'param_name' => 'cta_button_title_select_font',
							'value'      => array(
								esc_html__( 'Select Font Type', 'radiantthemes-addons' ) => '',
								esc_html__( 'Google Font', 'radiantthemes-addons' )      => 'gfont',
								esc_html__( 'Custom Font', 'radiantthemes-addons' )      => 'cfont',
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'cta_button_title_google_font',
							'dependency' => array(
								'element' => 'cta_button_title_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'cta_button_title_custom_font',
							'value'      => $final_font_array,
							'dependency' => array(
								'element' => 'cta_button_title_select_font',
								'value'   => 'cfont',
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Button Line Height (in px)', 'radiantthemes-addons' ),
							'param_name' => 'calltoaction_button_line_height',
							'value'      => '',
							'group'      => esc_html__( 'Typography & Color', 'radiantthemes-addons' ),
						),
						array(
		...
		public function radiantthemes_calltoaction_style_func( $atts, $content = null, $tag ) {
			$shortcode = shortcode_atts(
				array(
					...
					'calltoaction_button_line_height'   => '',
					'calltoaction_button_font_weight'   => '500',
					'cta_title_select_font'             => '',
					'cta_title_google_font'             => '',
					'cta_title_custom_font'             => '',
					'cta_content_select_font'           => '',
					'cta_content_google_font'           => '',
					'cta_content_custom_font'           => '',
					'cta_subtitle_select_font'          => '',
					'cta_subtitle_google_font'          => '',
					'cta_subtitle_custom_font'          => '',
					'cta_button_title_select_font'      => '',
					'cta_button_title_google_font'      => '',
					'cta_button_title_custom_font'      => '',
				),
				$atts
			);

			if ( 'gfont' === $shortcode['cta_title_select_font'] ) {
				// Build the call to action font array.
				$cta_title_google_font = $this->get_fonts_data( $shortcode['cta_title_google_font'] );

				// Build the inline style.
				$cta_title_font_inline_style = $this->google_fonts_styles( $cta_title_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $cta_title_google_font );
			} elseif ( 'cfont' === $shortcode['cta_title_select_font'] ) {
				// Build the inline style.
				$cta_title_font_inline_style = 'font-family: ' . $shortcode['cta_title_custom_font'];
			} else {
				$cta_title_font_inline_style = '';
			}

			if ( 'gfont' === $shortcode['cta_content_select_font'] ) {
				// Build the call to action font array.
				$cta_content_google_font = $this->get_fonts_data( $shortcode['cta_content_google_font'] );

				// Build the inline style.
				$cta_content_font_inline_style = $this->google_fonts_styles( $cta_content_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $cta_content_google_font );
			} elseif ( 'cfont' === $shortcode['cta_content_select_font'] ) {
				// Build the inline style.
				$cta_content_font_inline_style = 'font-family: ' . $shortcode['cta_content_custom_font'];
			} else {
				$cta_content_font_inline_style = '';
			}

			if ( 'gfont' === $shortcode['cta_subtitle_select_font'] ) {
				// Build the call to action font array.
				$cta_subtitle_google_font = $this->get_fonts_data( $shortcode['cta_subtitle_google_font'] );

				// Build the inline style.
				$cta_subtitle_font_inline_style = $this->google_fonts_styles( $cta_subtitle_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $cta_subtitle_google_font );
			} elseif ( 'cfont' === $shortcode['cta_subtitle_select_font'] ) {
				// Build the inline style.
				$cta_subtitle_font_inline_style = 'font-family: ' . $shortcode['cta_subtitle_custom_font'];
			} else {
				$cta_subtitle_font_inline_style = '';
			}

			if ( 'gfont' === $shortcode['cta_button_title_select_font'] ) {
				// Build the call to action font array.
				$cta_button_title_google_font = $this->get_fonts_data( $shortcode['cta_button_title_google_font'] );

				// Build the inline style.
				$cta_button_title_font_inline_style = $this->google_fonts_styles( $cta_button_title_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $cta_button_title_google_font );
			} elseif ( 'cfont' === $shortcode['cta_button_title_select_font'] ) {
				// Build the inline style.
				$cta_button_title_font_inline_style = 'font-family: ' . $shortcode['cta_button_title_custom_font'];
			} else {
				$cta_button_title_font_inline_style = '';
			}
			...
			$title_style = 'color:' . esc_attr( $shortcode['calltoaction_title_color'] ) . '; font-size:' . esc_attr( $shortcode['calltoaction_title_font_size'] ) . 'px; line-height:' . esc_attr( $shortcode['calltoaction_title_line_height'] ) . 'px;';

			$content_style = 'color:' . esc_attr( $shortcode['calltoaction_content_color'] ) . '; font-size:' . esc_attr( $shortcode['calltoaction_content_font_size'] ) . 'px; line-height:' . esc_attr( $shortcode['calltoaction_content_line_height'] ) . 'px;';

			$subtitle_style = 'color:' . esc_attr( $shortcode['calltoaction_subtitle_color'] ) . '; font-size:' . esc_attr( $shortcode['calltoaction_subtitle_font_size'] ) . 'px; line-height:' . esc_attr( $shortcode['calltoaction_subtitle_line_height'] ) . 'px;';

			$button_title_color            = $shortcode['calltoaction_button_title_color'];
			$button_font_size              = $shortcode['calltoaction_button_font_size'] . 'px';
			$button_line_height            = $shortcode['calltoaction_button_line_height'] . 'px';
			...
			$custom_css = ".rt-call-to-action-wraper.element-{$shortcode['calltoaction_style']} .rt-call-to-action-item .btn{ color: {$button_title_color}; font-size: {$button_font_size }; line-height: {$button_line_height}; font-weight: {$button_font_weight}; }";
