...
$output  = '<div style="' . $case_studies_filter_font_inline_style . '" class="rt-case-study-box-filter element-five filter-style-' . esc_attr( $shortcode['case_study_filter_style'] ) . ' text-' . esc_attr( $shortcode['case_study_filter_alignment'] ) . ' ' . esc_attr( $hidden_filter ) . '">';
