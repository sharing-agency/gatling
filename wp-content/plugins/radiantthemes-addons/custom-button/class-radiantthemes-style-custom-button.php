			...
			vc_map(
				array(
					...
					'params'      => array(
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Button Style', 'radiantthemes-addons' ),
							'param_name' => 'button_style',
							'value'      => array(
								esc_html__( 'Normal', 'radiantthemes-addons' )      => 'one',
								esc_html__( 'Left Skew', 'radiantthemes-addons' )   => 'two',
								esc_html__( 'Right Skew', 'radiantthemes-addons' )  => 'three',
							),
							'std'        => 'one',
						),
						array(
						...
						array(
							...
							'param_name' => 'custom_button_select_font',
							'value'      => array(
						...
						array(
							'type'       => 'google_fonts',
							'param_name' => 'custom_button_google_font',
							'dependency' => array(
								'element' => 'custom_button_select_font',
								'value'   => 'gfont',
							),
							'settings'   => array(
								'fields' => array(
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'custom_button_custom_font',
						...
						array(
							...
							'param_name' => 'custom_button_font_weight',
							'value'      => '400',
							'group'      => 'Typography',
							'dependency' => array(
								'element' => 'custom_button_select_font',
						...
						array(
							...
							'param_name'  => 'custom_button_font_style',
							'value'       => array(
						...
						array(
							'type'        => 'checkbox',
							'heading'     => esc_html__( 'Add Gradient Background?', 'radiantthemes-addons' ),
							...
							'param_name'  => 'gradient_background_add',
							'group'       => esc_html__( 'Button Design', 'radiantthemes-addons' ),
						),
						array(
							'type'        => 'dropdown',
							'heading'     => esc_html__( 'Gradient Background Type', 'radiantthemes-addons' ),
							'description' => esc_html__( 'Select backgroud type.', 'radiantthemes-addons' ),
							'value'       => array(
								esc_html__( 'To Bottom', 'radiantthemes-addons' )       => 'to bottom',
								esc_html__( 'To Top', 'radiantthemes-addons' )          => 'to top',
								esc_html__( 'To Right', 'radiantthemes-addons' )        => 'to right',
								esc_html__( 'To Left', 'radiantthemes-addons' )         => 'to left',
								esc_html__( 'To Top Left', 'radiantthemes-addons' )     => 'to top left',
								esc_html__( 'To Bottom Left', 'radiantthemes-addons' )  => 'to bottom left',
								esc_html__( 'To Top Right', 'radiantthemes-addons' )    => 'to top right',
								esc_html__( 'To Bottom Right', 'radiantthemes-addons' ) => 'to bottom right',
							),
							'param_name'  => 'gradient_background_type',
							'group'       => esc_html__( 'Button Design', 'radiantthemes-addons' ),
							'dependency'  => array(
								'element' => 'gradient_background_add',
								'value'   => 'true',
							),
						),
						array(
							'type'             => 'colorpicker',
							'heading'          => esc_html__( 'Background Color (One)', 'radiantthemes-addons' ),
							'param_name'       => 'gradient_background_color_one',
							'value'            => '',
							'group'            => esc_html__( 'Button Design', 'radiantthemes-addons' ),
						...
						array(
							'type'             => 'colorpicker',
							'heading'          => esc_html__( 'Background Color (Two)', 'radiantthemes-addons' ),
							'param_name'       => 'gradient_background_color_two',
							'value'            => '',
							'group'            => esc_html__( 'Button Design', 'radiantthemes-addons' ),
							'edit_field_class' => 'vc_col-xs-6 vc_column',
							'dependency'       => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Style Five (3D Shadow With SlideUp)', 'radiantthemes-addons' )  => 'five',
								esc_html__( 'Style Six (Horizontal Shake)', 'radiantthemes-addons' )         => 'six',
								esc_html__( 'Style Seven (Zoom Out)', 'radiantthemes-addons' )               => 'seven',
							),
							'std'         => 'one',
		...
		public function radiantthemes_custom_button_style_func( $atts, $content = null, $tag ) {
			$shortcode = shortcode_atts(
				array(
					...
					'font_hover_color'              => '',
					'animation'                     => '',
					'custom_button_select_font'     => '',
					'custom_button_google_font'     => '',
					'custom_button_custom_font'     => '',
					'custom_button_font_weight'     => '400',
					'custom_button_font_style'      => 'normal',
				),
				$atts
			);
			...
			if ( 'gfont' === $shortcode['custom_button_select_font'] ) {

				// Build the case studies filter font array.
				$custom_button_google_font = $this->get_fonts_data( $shortcode['custom_button_google_font'] );

				// Build the inline style.
				$custom_button_font_inline_style = $this->google_fonts_styles( $custom_button_google_font );

				// Enqueue the right font.
				$this->enqueue_google_fonts( $custom_button_google_font );

				$custom_button_font_weight_style = '';

			} elseif ( 'cfont' === $shortcode['custom_button_select_font'] ) {

				// Build the inline style.
				$custom_button_font_inline_style = 'font-family: ' . $shortcode['custom_button_custom_font'] . ';';
				$custom_button_font_weight_style = 'font-weight: ' . $shortcode['custom_button_font_weight'] . ';font-style: ' . $shortcode['custom_button_font_style'] . ';';

			} else {

				$custom_button_font_inline_style = '';
				$custom_button_font_weight_style = '';
			...
			// GRADIENT BACKGROUND.
			if ( ! empty( $shortcode['gradient_background_color_one'] ) || ! empty( $shortcode['gradient_background_color_two'] ) ) {
				$style      = '.radiantthemes-custom-button.' . $button_random_class . ' .radiantthemes-custom-button-main{';
					$style .= ( ! empty( $shortcode['gradient_background_color_one'] ) || ! empty( $shortcode['gradient_background_color_two'] ) ) ? ' background:linear-gradient(' . $shortcode['gradient_background_type'] . ', ' . $shortcode['gradient_background_color_one'] . ' 0%, ' . $shortcode['gradient_background_color_two'] . ' 100%);' : '';
				$style     .= '}';
			...
			if ( ! empty( $shortcode['background_hover_color'] ) || ! empty( $shortcode['border_hover_color'] ) || ! empty( $shortcode['font_hover_color'] ) ) {
				...
				if ( 'one' === $shortcode['button_hover_style'] ) {
					...
					$style     .= '}';
					wp_add_inline_style( 'radiantthemes-addons-custom', $style );
				} elseif ( 'five' === $shortcode['button_hover_style'] ) { // HOVER STYLE FIVE.
					...
					$style     .= '}';
					wp_add_inline_style( 'radiantthemes-addons-custom', $style );
				} elseif ( 'six' === $shortcode['button_hover_style'] ) { // HOVER STYLE SIX.
					...
					$style     .= '}';
					wp_add_inline_style( 'radiantthemes-addons-custom', $style );
				} elseif ( 'seven' === $shortcode['button_hover_style'] ) { // HOVER STYLE SEVEN.
			...
			$output .= '<div class="radiantthemes-custom-button element-' . esc_attr( $shortcode['button_style'] ) . ' hover-style-' . esc_attr( $shortcode['button_hover_style'] ) . ' ' . $button_random_class . ' ' . $animation_classes . ' ' . esc_attr( $shortcode['extra_class'] ) . '" ' . $button_id . ' data-button-direction="' . $shortcode['align'] . '"';
			...
			if ( strlen( $url['url'] ) > 0 ) {
				$output .= '<a style="' . $button_text_style . $custom_button_font_inline_style . $custom_button_font_weight_style . '" class="radiantthemes-custom-button-main ' . esc_attr( $button_class ) . '" href="' . esc_attr( $url['url'] ) . '" ' . $rel . ' title="' . esc_attr( $url['title'] ) . '" target="' . ( strlen( $url['target'] ) > 0 ? esc_attr( $url['target'] ) : '_self' ) . '">';
				// HOVER STYLE ONE.
